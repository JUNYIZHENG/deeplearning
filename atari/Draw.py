...
parser.add_argument('--frame_skip', type=int, default=1,
                    help='for Atari, skip frames by repeating action, \
                        useful for NoFrameSkip-v4 envionments')
parser.add_argument('--frame_stack', type=int, default=4,
                    help='for Atari, stack 4 consecutive frames together \
                        as observations')
...
env = Env.LocalEnv(args.env, 1, args.frame_skip, args.frame_stack,
